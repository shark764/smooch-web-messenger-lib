...
const cxengageWebScript = document.querySelector("script[src='http://webchat.cxengage.net/load-chat.js']");
let cxengageWebAppId, cxengageTenantId, cxengageRegion;
if (cxengageWebScript) {
  ...
  if (!cxengageWebAppId || !cxengageTenantId) {
    throw new Error('One or both of web-app-id and tenant-id not passed into script as data attributes. web-app-id: ' + cxengageWebAppId + ', tenant-id: ' + cxengageTenantId);
  }
} else {
